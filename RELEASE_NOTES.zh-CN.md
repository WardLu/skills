...
> **类型**: 文档视觉层、发布说明对齐与审计修复
>
> **GitHub Release**: [v0.4.2](https://github.com/WardLu/skills/releases/tag/v0.4.2)

### 新增

- 根 README 视觉层：英文与简体中文各一套主视觉和四步发布流程图，均为纯 SVG，
  文字对比度达到 WCAG AA。

### 变更

- **`github-repo-i18n` → v0.1.2**：一致性审计现在按去掉语言段后的中性路径比较跨文档族的
  链接，正确的语言对不再被误报为内容链接不一致。
- 发布说明改为双语：`RELEASE_NOTES.md` 为英文默认，`RELEASE_NOTES.zh-CN.md` 保留中文
  内容，两者都由根 README 链接。

### 修复

- 回填了缺失的 v0.3.0 与 v0.4.0 发布说明条目。
