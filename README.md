...
[![Collection version 0.4.1](https://img.shields.io/badge/collection%20version-0.4.2-2563eb.svg)](VERSION)
...
| `github-repo-i18n` | Keep selected repository documentation aligned across locales. | `0.1.2` | [English](github-repo-i18n/README.md) · [简体中文](github-repo-i18n/README.zh-CN.md) |
...
| `shadow-skill-publisher` | Validate, package, and track a local Agent Skill before manual publication. | `0.6.4` | [English](shadow-skill-publisher/README.md) · [简体中文](shadow-skill-publisher/README.zh-CN.md) |
...
search the skills.sh source or add this repository as a GitHub tap, then
inspect and install individual Skills through its Skills Hub. Review the source
and required permissions before installing any third-party Skill.
