...
class AdapterTests(unittest.TestCase):
    ...
    def test_workbuddy_injects_required_listing_metadata_without_changing_body(self):
        ...
        self.assertIn("_skillhub_meta.json", staging.files)
        market_meta = json.loads(staging.files["_skillhub_meta.json"].decode("utf-8"))
    ...
    def test_registry_uses_explicit_cli_keys_and_replaces_verified_channel_placeholders_only(self):
        self.assertEqual(
            CHANNEL_KEYS,
            ("workbuddy", "skillpay", "zhihu-ai-works", "xiaohongshu-red-skill"),
        )
