...
Packages can currently be prepared for LovStudio, WorkBuddy, SkillPay, and
Xiaohongshu Red Skill. Zhihu AI Works is not available until its creator form
...
```text
Check and prepare /path/to/my-skill for LovStudio and WorkBuddy.
```
